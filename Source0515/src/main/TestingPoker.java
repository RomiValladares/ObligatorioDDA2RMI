...
public class TestingPoker {
	...
	public void testearOrdenamientoFiguras() {
            try {
                //
                JugadorV1 jugador1 = new JugadorV1("j1");
                ...
                JugadorYFigura j1 = new JugadorYFigura(jugador1, figuraManoConPoker,
                        manoConPoker1);
                //
                JugadorV1 jugador2 = new JugadorV1("j2");
                ...
                JugadorYFigura j2 = new JugadorYFigura(jugador2, figuraManoConPoker2,
                        manoConPoker2);
                //
                JugadorV1 jugador3 = new JugadorV1("j3");
                ...
                JugadorYFigura j3 = new JugadorYFigura(jugador3, figuraManoConPar,
                        manoConPar);
                //
                JugadorV1 jugador4 = new JugadorV1("j4");
                ...
                JugadorYFigura j4 = new JugadorYFigura(jugador4, figuraManoConPar2,
                        manoConPar2);
                //
                JugadorV1 jugador5 = new JugadorV1("j5");
                ...
                JugadorYFigura j5 = new JugadorYFigura(jugador5, sinFigura,
                        manoSinFigura);
                //
                JugadorV1 jugador6 = new JugadorV1("j6");
                ...
                Logger.getLogger(TestingPoker.class.getName()).log(Level.SEVERE, null, ex);
            }
	}
	...
	public void testearDesempateSinFiguras() {
            try {
                ...
                JugadorV1 j1 = new JugadorV1("JUGADOR1");
                ...
                JugadorV1 j2 = new JugadorV1("JUGADOR2");
                ...
                SimpleEntry<JugadorV1, FiguraPoker> ganador = mano.obtenerGanador();
